...
determines, and per-type slot legality qualifies. Liveness that is **derived**
...
`is_error: true`, and that flag is how the model knows to self-correct.
...
Arrays meaning "items to include" require `.min(1)`, since an empty inclusion
