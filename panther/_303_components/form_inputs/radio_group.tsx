...
export function RadioGroup<T extends string>(p: RadioGroupProps<T>) {
  const useSelect = () =>
    p.convertToSelectThreshold !== undefined &&
    p.options.length > p.convertToSelectThreshold;
                  ...
                  <label class="flex w-fit items-center">
                    <div class="relative mr-2 h-5 w-5 flex-none">
                      <input
                        ...
                        class="ui-focusable bg-base-100 text-base-content peer h-5 w-5 cursor-pointer appearance-none rounded-full border"
                      />
