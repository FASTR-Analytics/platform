...
export { calculateMinSubChartHeight, calculatePaneGrid, calculateYScaleLimits, checkValuePropsAssignment, collectHeaders, createSortFunction, estimateMinSurroundsWidth, estimateMinYAxisWidth, fillValuesWithDuplicateCheck, findOptimalScaleForBounds, generateChartPrimitives, generateSurroundsPrimitives, getHeaderIndex, measureChart, measureSurrounds, renderFigurePrimitives, resolveFigureAutofitOptions, validateDataInput, withAnyLabelReplacement } from "../_007_figure_core/mod.ts";
export type { FigureInputsBase, JsonArray, LegendItem, MeasuredPaneBase, MeasuredSurrounds, ProcessedHeaders, SimplifiedChartConfig, XTextAxisMeasuredInfo, YScaleAxisData } from "../_007_figure_core/mod.ts";
