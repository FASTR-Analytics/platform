...
**Anchor Points**: The `x, y` coordinates specify where the anchor point is
located. The box is then positioned relative to that anchor:
...
### Auto-Sizing with Anchor Points (Recommended)
