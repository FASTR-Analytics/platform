...
const CLIENT_INFO_TOPICS: InfoCatalogTopic[] = [
  {
    ...
    description:
      "Step-by-step recipe for building an ICEH/Countdown equity profile as a report from the results package's ICEH survey data. Load when asked to create an ICEH equity profile.",
  },
];
