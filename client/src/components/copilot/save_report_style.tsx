...
// before it enters the library. The call rides the governed instance AI
// proxy (the same client the chat uses).
...
type Props = AlertComponentProps<
  { productId: string; reportLabel: string; body: string },
