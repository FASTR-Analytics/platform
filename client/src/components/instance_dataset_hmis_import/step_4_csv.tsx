...
export function Step4_Csv(p: Props) {
  ...
  return (
    <div class="ui-spy ui-pad">
      <div class="ui-spy">
        <div class="font-700 text-lg">{t3({ en: "Staging Complete", fr: "Préparation terminée", pt: "Preparação concluída" })}</div>

        <div class="ui-pad bg-base-200 rounded">
          <div class="flex justify-between">
            <span class="text-base-content">{t3({ en: "Source:", fr: "Source :", pt: "Fonte:" })}</span>
            <span class="font-mono">{t3({ en: "CSV Import", fr: "Importation CSV", pt: "Importação CSV" })}</span>
          </div>
          <div class="flex justify-between">
