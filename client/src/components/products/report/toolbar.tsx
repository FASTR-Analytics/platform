...
// lives here rather than being reached out of panther, whose set is private.
...
type Props = {
  ...
  // The full theme picker (real stylesheet previews, and the saved custom
  // styles): the flyout below is the quick switch between built-in themes.
