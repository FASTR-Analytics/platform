  ...
  return (
    <div class="flex h-full w-full flex-col border-r">
      <div class="flex w-full flex-none border-b">
        <div
          class="ui-hoverable-base-100 data-[selected=true]:bg-base-200 flex-1 truncate border-r px-2 py-2 text-center"
          onClick={() => setTab("data")}
        ...
        <div
          class="ui-hoverable-base-100 data-[selected=true]:bg-base-200 flex-1 truncate px-2 py-2 text-center"
          onClick={() => setTab("text")}
