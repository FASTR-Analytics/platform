...
//     if (saved?.input) {
//       const pageInputs = await convertWhiteboardInputToPageInputs(projectId, saved.input, projectDetail.metrics);
...
//     getToolsForWhiteboard(projectId, conversationId, setContent, projectDetail.projectModules, projectDetail.metrics)
//   );

//   const systemPrompt = createMemo(() =>
//     getWhiteboardSystemPrompt(p.instanceDetail, projectDetail)
//   );
