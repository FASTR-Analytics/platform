...
// Step 3: confirm: label and selection summary. There is no pre-launch
// compatibility report (the run does not exist yet); robustness comes from the
// typed not-in-run / unavailable render states.
