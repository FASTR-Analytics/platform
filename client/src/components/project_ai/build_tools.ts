...
import { z } from "zod";
import type { InstalledModuleSummary, MetricWithStatus, AiContentSlideInput } from "lib";
import { AiContentBlockInputSchema } from "lib";
import { getToolsForMetrics } from "../ai_tools/tools/metrics";
import { getToolsForModules } from "../ai_tools/tools/modules";
import { getToolsForReadingVisualizations } from "../ai_tools/tools/visualization_reading";
...
import { getToolsForConfiguringVisualizations } from "../ai_tools/tools/visualization_config";
import { getToolForVisualizationData } from "../ai_tools/tools/visualization_reading";
import { validateMaxContentBlocks, validateNoMarkdownTables } from "../ai_tools/validators/content_validators";
