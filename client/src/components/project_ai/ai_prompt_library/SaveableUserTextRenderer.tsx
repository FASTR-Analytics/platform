  ...
  return (
    <div class="group ml-auto flex max-w-[80%] items-start gap-1">
      <button
        ...
        onClick={handleSave}
        class="bg-base-100 border-base-300 text-base-content/60 hover:text-base-content mt-1 flex h-7 w-7 shrink-0 items-center justify-center rounded border opacity-0 transition-opacity group-hover:opacity-100"
      >
        <svg
