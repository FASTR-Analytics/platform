...
import App from "./app";
// Applies the theme's tokens to <html> at module scope, so the read below
// sees the themed values whatever the component import graph does.
import "./state/t4_theme";
import {
  BASE_TEXT_OPTIONS,
  GLOBAL_STYLE_OPTIONS,
} from "./generate_visualization/get_style_from_po/_0_common";

// The canvas key colours are the CSS --color-* tokens as themed, both
// halves, so a figure's base300 is the UI's base-300 in either scheme
// (FigureHolder scopes the dark half per render; exports stay light). The remap opt-in
