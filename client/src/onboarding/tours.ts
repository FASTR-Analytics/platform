  ...
  return {
    ...
    steps: [
      ...
      slideTypeStep(),
      {
        ...
        body: t3({
          en: "Type the title and other text straight onto the slide. The Text menu adds a subtitle, presenter or date; select any of them to change its size, bold and italic here.",
          fr: "Tapez le titre et les autres textes directement sur la diapositive. Le menu Texte ajoute un sous-titre, un présentateur ou une date ; sélectionnez-en un pour ajuster ici sa taille, le gras et l'italique.",
          pt: "Escreva o título e o restante texto diretamente no diapositivo. O menu Texto adiciona um subtítulo, apresentador ou data; selecione um deles para ajustar aqui o tamanho, o negrito e o itálico.",
        }),
        placement: "bottom",
      },
      slideCanvasStep(),
  ...
  return {
    ...
    steps: [
      ...
      slideTypeStep(),
      {
        ...
        body: t3({
          en: "A section slide is deliberately simple: a title and an optional subtitle (add it from the Text menu). Type on the slide; select either one to adjust its size, bold and italic here.",
          fr: "Une diapositive de section est volontairement simple : un titre et un sous-titre facultatif (ajoutez-le depuis le menu Texte). Tapez sur la diapositive ; sélectionnez l'un ou l'autre pour ajuster ici la taille, le gras et l'italique.",
          pt: "Um diapositivo de secção é deliberadamente simples: um título e um subtítulo opcional (adicione-o no menu Texto). Escreva no diapositivo; selecione um deles para ajustar aqui o tamanho, o negrito e o itálico.",
        }),
        placement: "bottom",
      },
      slideCanvasStep(),
  ...
  return {
    ...
    steps: [
      ...
      slideCanvasStep(),
      {
        ...
        body: t3({
          en: "The Text menu adds a header, sub-header, date or footer; Split panel divides the slide so text can sit beside a chart. The row below follows what you select: formatting while you type, a block's options when you click one.",
          fr: "Le menu Texte ajoute un en-tête, un sous-titre, une date ou un pied de page ; Panneau divisé partage la diapositive pour placer du texte à côté d'un graphique. La ligne du dessous suit votre sélection : la mise en forme pendant la saisie, les options d'un bloc quand vous cliquez dessus.",
          pt: "O menu Texto adiciona um cabeçalho, subcabeçalho, data ou rodapé; Painel dividido divide o diapositivo para colocar texto ao lado de um gráfico. A linha de baixo acompanha o que seleciona: formatação enquanto escreve, as opções de um bloco quando clica nele.",
        }),
        placement: "bottom",
      },
      {
