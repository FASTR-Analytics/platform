...
-- + followers"): runs.pinned marks the at-most-one package the instance
-- blesses for consumption (the partial unique index enforces the
-- cardinality); projects.follow_pinned subscribes a project to a physical
-- repoint whenever the pin moves.
