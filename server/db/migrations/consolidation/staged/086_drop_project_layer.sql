...
-- ============================================================================
--
-- Runs after 085 has copied every project's products into the products
-- tables.
--
...
-- would wipe the logs. Dropping the COLUMN severs each FK first, and the
-- tables then drop with nothing left pointing at them.
--
...
-- guarded DO block merges the rows that differed only by project_id BEFORE
-- the column goes; otherwise the rebuilt unique index would collide.
-- ============================================================================
