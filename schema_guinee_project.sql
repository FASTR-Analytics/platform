...
--
-- Name: ro_m4_combined_results_admin2_csv; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.ro_m4_combined_results_admin2_csv (
    admin_area_1 text NOT NULL,
...
ALTER TABLE public.ro_m4_combined_results_admin2_csv OWNER TO postgres;

--
-- Name: ro_m4_combined_results_admin3_csv; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.ro_m4_combined_results_admin3_csv (
    admin_area_1 text NOT NULL,
    admin_area_3 text NOT NULL,
    year integer NOT NULL,
    indicator_common_id text NOT NULL,
...
ALTER TABLE public.ro_m4_combined_results_admin3_csv OWNER TO postgres;

--
-- Name: ro_m4_combined_results_national_csv; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.ro_m4_combined_results_national_csv (
    admin_area_1 text NOT NULL,
    year integer NOT NULL,
    indicator_common_id text NOT NULL,
    denominator_best_or_survey text NOT NULL,
...
ALTER TABLE public.ro_m4_combined_results_national_csv OWNER TO postgres;
...
--
-- Name: ro_m4_denominators_admin2_csv; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.ro_m4_denominators_admin2_csv (
    admin_area_1 text NOT NULL,
    admin_area_2 text NOT NULL,
    year integer NOT NULL,
...
ALTER TABLE public.ro_m4_denominators_admin2_csv OWNER TO postgres;

--
-- Name: ro_m4_denominators_admin3_csv; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.ro_m4_denominators_admin3_csv (
    admin_area_1 text NOT NULL,
    admin_area_3 text NOT NULL,
    year integer NOT NULL,
    denominator text NOT NULL,
...
ALTER TABLE public.ro_m4_denominators_admin3_csv OWNER TO postgres;

--
-- Name: ro_m4_denominators_national_csv; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.ro_m4_denominators_national_csv (
    admin_area_1 text NOT NULL,
    year integer NOT NULL,
    denominator text NOT NULL,
    source_indicator text,
...
ALTER TABLE public.ro_m4_denominators_national_csv OWNER TO postgres;
...
--
-- Name: ro_m5_coverage_estimation_admin2_csv; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.ro_m5_coverage_estimation_admin2_csv (
    admin_area_1 text NOT NULL,
    admin_area_2 text NOT NULL,
    year integer NOT NULL,
    indicator_common_id text NOT NULL,
...
ALTER TABLE public.ro_m5_coverage_estimation_admin2_csv OWNER TO postgres;

--
-- Name: ro_m5_coverage_estimation_admin3_csv; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.ro_m5_coverage_estimation_admin3_csv (
    admin_area_1 text NOT NULL,
    admin_area_3 text NOT NULL,
    year integer NOT NULL,
    indicator_common_id text NOT NULL,
...
ALTER TABLE public.ro_m5_coverage_estimation_admin3_csv OWNER TO postgres;

--
-- Name: ro_m5_coverage_estimation_national_csv; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.ro_m5_coverage_estimation_national_csv (
    admin_area_1 text NOT NULL,
    year integer NOT NULL,
    indicator_common_id text NOT NULL,
    denominator text NOT NULL,
...
ALTER TABLE public.ro_m5_coverage_estimation_national_csv OWNER TO postgres;
