...
- [DOC_VERSION_HISTORY.md](DOC_VERSION_HISTORY.md) — report/deck version history: editing-session capture + attribution, hash-dedup/retention, restore sequencing, room-discard rules
