...
def build_prompt(diff_text, pages_dict):
    return (
        ...
        "- Terminology (use exactly): Instance | Product | Folder | Admin area | Facility | "
        "Module | Slide deck | Report | Results package | Visualization\n"
        ...
        "      \"screenshots\": [\n"
        "        {\n"
        "          \"image_path\": \"/images/user-permissions-en.png\",\n"
