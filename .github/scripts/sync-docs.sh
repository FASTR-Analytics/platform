...
def build_prompt(diff_text, pages_dict):
    return (
        ...
        "- Terminology (use exactly): Instance | Product | Folder | Scope | Admin area | "
        "Facility | Module | Results package | Slide deck | Report | Figure\n"
        ...
        "      \"screenshots\": [\n"
        "        {\n"
        "          \"image_path\": \"/images/products-en.png\",\n"
        "          \"placeholder_description\": null,\n"
        "          \"reason\": \"Products page now has a list view toggle\"\n"
        "        },\n"
        "        {\n"
        "          \"image_path\": null,\n"
