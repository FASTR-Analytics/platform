...
// Last generated: 2026-02-10T05:18:34.048Z
...
export function getModuleIdForMetric(metricId: string): ModuleId {
  ...
  if (!moduleId) {
    throw new Error(
      `Unknown metricId: ${metricId}. This may indicate a migration issue.`,
    );
  }
  return moduleId;
}
...
export function getModuleIdForResultsObject(resultsObjectId: string): ModuleId {
  ...
  if (!moduleId) {
    throw new Error(
      `Unknown resultsObjectId: ${resultsObjectId}. This may indicate a migration issue.`,
    );
  }
  return moduleId;
}
...
export const METRIC_STATIC_DATA: Record<
  string,
  {
    label: string;
    variantLabel?: string;
...
> = {
    ...
    vizPresets: [
      {
        ...
        label: {
          ...
          fr: "Outlier proportion table",
        },
        description: {
          en: "Table showing proportion of outliers by indicator and region",
          fr: "Table showing proportion of outliers by indicator and region",
        },
        config: {
          d: {
            type: "table",
    ...
    vizPresets: [
      {
        ...
        label: {
          ...
          fr: "Completeness table by region",
        },
        description: {
          en: "Table showing completeness by indicator and region",
          fr: "Table showing completeness by indicator and region",
        },
        config: {
          d: {
            type: "table",
      ...
      },
      {
        ...
        description: {
          ...
          fr: "Area chart showing completeness trends over time by indicator",
        },
        config: {
          d: {
            type: "timeseries",
    ...
    vizPresets: [
      {
        ...
        label: {
          ...
          fr: "Internal consistency table",
        },
        description: {
          en: "Table showing consistency by ratio type and region",
          fr: "Table showing consistency by ratio type and region",
        },
        config: {
          d: {
            type: "table",
    ...
    vizPresets: [
      {
        ...
        description: {
          ...
          fr: "Table showing DQA scores by region and year",
        },
        config: {
          d: {
            type: "table",
    ...
    vizPresets: [
      {
        ...
        description: {
          ...
          fr: "Table showing mean DQA scores by region and year",
        },
        config: {
          d: {
            type: "table",
  ...
  "m1-05-01": {
    ...
    valueFunc: "SUM",
    formatAs: "number",
    valueLabelReplacements: { dqa_score: "Indicator outliers" },
    requiredDisaggregationOptions: [],
  },
  "m2-01-01": {
    ...
    valueFunc: "identity",
    formatAs: "percent",
    valueLabelReplacements: { pct_change: "Percent change" },
    requiredDisaggregationOptions: [],
    ...
    vizPresets: [
      {
        ...
        label: {
          ...
          fr: "Service volume over time (monthly)",
        },
        description: {
          en: "Line chart showing monthly service volume by indicator",
          fr: "Line chart showing monthly service volume by indicator",
        },
        config: {
          d: {
            type: "timeseries",
      ...
      },
      {
        ...
        description: {
          ...
          fr: "Bar chart showing quarterly volume with quarter-on-quarter change",
        },
        config: {
          d: {
            type: "timeseries",
      ...
      },
      {
        ...
        description: {
          ...
          fr: "Bar chart showing annual volume with year-on-year change",
        },
        config: {
          d: {
            type: "timeseries",
      ...
      },
      {
        ...
        label: {
          ...
          fr: "Volume annual change by region",
        },
        description: {
          en: "Bar chart showing annual volume change by indicator and admin area",
          fr: "Bar chart showing annual volume change by indicator and admin area",
        },
        config: {
          d: {
            type: "timeseries",
      ...
      },
      {
        ...
        label: {
          ...
          fr: "Data quality adjustment comparison",
        },
        description: {
          en: "Line chart comparing volume under different adjustment scenarios",
          fr: "Line chart comparing volume under different adjustment scenarios",
        },
        config: {
          d: {
            type: "timeseries",
    ...
    vizPresets: [
      {
        ...
        label: {
          ...
          fr: "Disruptions and surpluses (national)",
        },
        description: {
          en: "Area chart showing actual vs expected service volume nationally",
          fr: "Area chart showing actual vs expected service volume nationally",
        },
        config: {
          d: {
            type: "timeseries",
  ...
  "m3-02-02": {
    ...
    valueFunc: "identity",
    formatAs: "percent",
    valueLabelReplacements: { pct_diff: "Percent difference" },
    requiredDisaggregationOptions: ["indicator_common_id"],
    postAggregationExpression: {
      ingredientValues: [
    ...
    vizPresets: [
      {
        id: "disruption-chart",
        label: {
          en: "Disruptions and surpluses (subnational)",
          fr: "Disruptions and surpluses (subnational)",
        },
        description: {
          en: "Area chart showing actual vs expected service volume by region",
          fr: "Area chart showing actual vs expected service volume by region",
        },
        config: {
          d: {
            type: "timeseries",
    ...
    vizPresets: [
      {
        ...
        label: {
          ...
          fr: "Coverage timeseries (national)",
        },
        description: {
          en: "National coverage timeseries with survey benchmarks",
          fr: "National coverage timeseries with survey benchmarks",
        },
        needsReplicant: true,
        config: {
          d: {
    ...
    vizPresets: [
      {
        ...
        label: {
          ...
          fr: "Coverage timeseries by region",
        },
        description: {
          en: "Coverage trends over time by admin area 2",
          fr: "Coverage trends over time by admin area 2",
        },
        config: {
          d: {
            type: "timeseries",
      ...
      },
      {
        ...
        label: {
          ...
          fr: "Coverage bar chart by region",
        },
        description: {
          en: "Bar chart comparing coverage across regions",
          fr: "Bar chart comparing coverage across regions",
        },
        needsReplicant: true,
        config: {
          d: {
    ...
    vizPresets: [
      {
        ...
        label: {
          ...
          fr: "Denominator values table",
        },
        description: {
          en: "Table of denominator values by source and year",
          fr: "Table of denominator values by source and year",
        },
        config: {
          d: {
            type: "table",
    ...
    vizPresets: [
      {
        ...
        label: {
          ...
          fr: "Coverage by denominator type",
        },
        description: {
          en: "Timeseries comparing coverage across denominator sources",
          fr: "Timeseries comparing coverage across denominator sources",
        },
        needsReplicant: true,
        config: {
          d: {
    ...
    vizPresets: [
      {
        ...
        label: {
          ...
          fr: "Coverage timeseries by district",
        },
        description: {
          en: "Coverage trends over time by admin area 3",
          fr: "Coverage trends over time by admin area 3",
        },
        needsReplicant: true,
        config: {
          d: {
      ...
      },
      {
        ...
        label: {
          ...
          fr: "Coverage bar chart by district",
        },
        description: {
          en: "Bar chart comparing coverage across districts",
          fr: "Bar chart comparing coverage across districts",
        },
        needsReplicant: true,
        config: {
          d: {
