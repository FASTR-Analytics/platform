...
// Last generated: 2026-03-26T11:52:10.872Z
    ...
    vizPresets: [
      ...
      },
      {
        ...
        config: {
          ...
          s: { content: "areas", decimalPlaces: 1 },
          t: {
            caption: {
        ...
        config: {
          ...
          t: {
            ...
            footnote: {
              ...
              fr: "Le volume annuel est ajusté pour les valeurs aberrantes CLAUDE TO DO.",
            },
          },
        },
      },
    ...
    vizPresets: [
      {
        ...
        config: {
          ...
          s: { conditionalFormatting: "fmt-neg10-pos10", decimalPlaces: 0 },
        },
      },
      {
        ...
        config: {
          ...
          s: { mapColorFrom: "#fee0d2", mapColorTo: "#de2d26" },
        },
      },
    ],
  },
...
export function getMetricStaticData(metricId: string) {
  ...
  return {
    ...data,
    label: t3(data.label),
    variantLabel: data.variantLabel ? t3(data.variantLabel) : undefined,
    importantNotes: data.importantNotes ? t3(data.importantNotes) : undefined,
  };
}
